/// <reference path="../../catalit-web/DataProvider/DataProvider.ts" />
/// <reference path="../../catalit-web/libs/sha256/sha256.d.ts" />
...
module CatalitWeb {
	...
	export class CatalitWebApp {
		private readonly secretKey = 'iOpDvZqDCZ53doSkajYjMes11OabXliP3BhT8nBoK9ab2zVAPqSpq4BgAgMdvib4RyWRcS';
		private readonly appID = '115';
