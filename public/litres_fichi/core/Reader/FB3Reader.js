...
(function (FB3Reader) {
    ...
    var Reader = (function () {
        function Reader(EnableBackgroundPreRender, Site, FB3DOM, Bookmarks, Version, PagesPositionsCache, TrackReading) {
            ...
            this.CachingDone = {};
            this.PageReadTimers = [];
            this.ReadProgress = new FB3BookReadProgress.BookReadProgress(this);
            this.IdleOff();
        }
